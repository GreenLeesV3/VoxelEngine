...
pub use fire::{
    ...
    PLANKS_BURN_TICKS, SPREAD_DELAY_TICKS, SmokeKind, WOOD_BURN_TICKS,
};
pub use fluid::{ContactEvent, FluidSim};
pub use weathering::{
    DIRT_SOAK_TICKS, GRASS_SOAK_TICKS, MUD_DISSOLVE_TICKS, MUD_DRY_TICKS, MUDDY_SETTLE_TICKS,
    POLLUTE_SPREAD_TICKS, STONE_ERODE_TICKS, STONE_FALL_BOOST, WeatherTable, Weathering,
};
