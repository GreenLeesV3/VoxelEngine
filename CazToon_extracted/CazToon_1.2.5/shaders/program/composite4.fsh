...
vec2 wideDirection = vec2(texelSize.x * BLOOM_RADIUS * BLOOM_CLOSE_RADIUS * 3.5 * BLOOM_RENDER_SCALE, 0.0);
vec2 tightDirection = vec2(texelSize.x * BLOOM_RADIUS * BLOOM_FAR_RADIUS * 1.6 * BLOOM_RENDER_SCALE, 0.0);
