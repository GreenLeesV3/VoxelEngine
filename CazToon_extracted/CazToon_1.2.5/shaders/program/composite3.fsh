...
vec2 wideDirection = vec2(0.0, texelSize.y * BLOOM_RADIUS * BLOOM_CLOSE_RADIUS * 2.0 * BLOOM_RENDER_SCALE);
vec2 tightDirection = vec2(0.0, texelSize.y * BLOOM_RADIUS * BLOOM_FAR_RADIUS * 0.85 * BLOOM_RENDER_SCALE);
