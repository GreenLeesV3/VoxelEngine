...
vec2 wideDirection = vec2(0.0, texelSize.y * BLOOM_RADIUS * BLOOM_CLOSE_RADIUS * 8.0 * BLOOM_RENDER_SCALE);
vec2 tightDirection = vec2(0.0, texelSize.y * BLOOM_RADIUS * BLOOM_FAR_RADIUS * 3.0 * BLOOM_RENDER_SCALE);
